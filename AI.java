...
public class AI extends Player{
	...
	// override chooseBox and chooseBoard methods
	// from parent player. AI uses random numbers to
	// generate moves
	@Override
	public int chooseBox() {
		int randomMove = (int)(Math.random()*9);
		System.out.println("Choose a box to place your mark (1-9): " + Integer.toString(randomMove+1));
		return randomMove;
	}	
	@Override
	public int chooseBoard() {
		int randomMove = (int)(Math.random()*9);
		System.out.println("Choose a board to play on (1-9): " + Integer.toString(randomMove+1));
		return randomMove;
	}
}
